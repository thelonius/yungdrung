...
# Читается и разбором дат, и подписями повторений (`domain.recurrence` берёт
# таблицу отсюда): одно название дня на всё приложение.
ДНИ_ИМЕНИТЕЛЬНЫЙ = ("понедельник", "вторник", "среда", "четверг",
                    "пятница", "суббота", "воскресенье")


def weekday_name(value) -> str:
    """Название дня недели для подписи: «пятница»."""
    return ДНИ_ИМЕНИТЕЛЬНЫЙ[as_date(value).weekday()]
